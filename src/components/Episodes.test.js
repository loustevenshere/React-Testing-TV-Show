...
// Some kind of acton, you need UserEvent
...
test('On first render, no episodes are displayed', () => {
    render(<Episodes episodes={[]} />)
    //Arrange, Act, Assert

    //query for Episode and make a "negative assertion"
    const episode = screen.queryAllByText(/episode/i);
    expect(episode).toHaveLength(0);
});

// You have to pass in props data that the component is expecting 
test("Component rerenders with episodes when props change", () => {
